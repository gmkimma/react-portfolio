...
export default class BlogForm extends Component {
  constructor (props) {
    ...
    this.state = {
      ...
      content: '',
      featured_image: '',
      apiUrl: 'https://gregkimma.devcamp.space/portfolio/portfolio_blogs',
      apiAction: 'post'
    }
  ...
  componentWillMount () {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://gregkimma.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: 'patch'
      })
    }
  }
  ...
  handleSubmit (e) {
    axios({
      ...
      .then(r => {
        ...
        if (this.props.editMode) {
          this.props.handleUpdateFormSubmission(r.data.portfolio_blog)
        } else {
